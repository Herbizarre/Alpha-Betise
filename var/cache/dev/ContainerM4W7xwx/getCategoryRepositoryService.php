...
{
    /**
     * Gets the private 'App\Repository\Newsletters\CategoryRepository' shared autowired service.
     *
     * @return \App\Repository\Newsletters\CategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Newsletters'.\DIRECTORY_SEPARATOR.'CategoryRepository.php';

        return $container->privates['App\\Repository\\Newsletters\\CategoryRepository'] = new \App\Repository\Newsletters\CategoryRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
